...
```{r}
DonorHistory_AF1 <- DonorHistoryRetention[which(DonorHistoryRetention$Annual.Fund.Idicator == '1'),]
...
```
####################################################################################################
Everything before this needs to be deleted

## Read in Data
```{r}
RetDataPercLong <- read.csv("RetDataPercLong.csv")
RetDataScholPercLong <- read.csv("RetDataScholPercLong.csv")
```
