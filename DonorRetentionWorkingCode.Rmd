...
RetentionDataPercents <- CalcRetPerc(Retention)

RetDataPercLong <- RetentionDataPercents %>%
...
ggplot(data = RetDataPercLong) +
  ...
  labs(title = "Donor Retention Over the Years", subtitle = "Retention of donors in a given year who returned in following years") +
